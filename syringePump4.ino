...
#define SYRINGE_BARREL_LENGTH_MM 75.0
...
const int mLBolusStepsLength = 4;
float mLBolusSteps[4] = {0.500, 1.000, 5.000, 10.000};

/* -- Default Parameters -- */
float mLBolus = 10.00; //default bolus size
float mLBigBolus = 30.00; //default large bolus size
float mLUsed = 0.0;
...
void processSerial(){
  ...
  #define SPEED_MICROSECONDS_DELAY 465 //longer delay = lower speed (465 = 10mL/min)
		bolus(PULL);
		updateScreen();
	}
